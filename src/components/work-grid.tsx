...
const projects = [
  ...
  },
  {
    ...
    dataAiHint: 'biometric scan interface',
  ...
  },
  {
    ...
    dataAiHint: 'fitness tracking dashboard',
  ...
  },
  {
    ...
    dataAiHint: 'logistics fleet management',
  ...
  },
  {
    ...
    dataAiHint: 'minimal personal AI assistant',
  ...
  },
  {
    ...
    dataAiHint: 'game development editor',
...
function ProjectCard({ project, index, isFeatured = false }: { project: typeof projects[0], index: number, isFeatured?: boolean }) {
  ...
  return (
    <motion.div
      ...
      className={`relative glass-card h-full min-h-[500px] border border-white/5 overflow-hidden flex flex-col group/project transition-all duration-700 hover:border-primary/40 active:scale-[0.99] rounded-[2rem] shadow-2xl ${isFeatured ? 'p-0' : 'p-8'}`}
    >
      {/* Radial Glow Effect */}
          ...
          <div className="p-12 pb-0 z-20 flex-1 flex flex-col">
            ...
            <div className="relative h-[400px] w-full rounded-t-[3rem] overflow-hidden mt-auto border-t border-x border-white/5 group-hover/project:border-primary/20 transition-colors duration-700">
              <Image
                ...
                priority={index === 0}
                alt={project.title}
                className="object-cover object-top group-hover/project:scale-110 transition-all duration-1000 ease-out translate-z-10"
              />
...
export default function PortfolioShowcase() {
  ...
  return (
    <section id="selected-work" className="w-full py-32 relative" suppressHydrationWarning={true}>
